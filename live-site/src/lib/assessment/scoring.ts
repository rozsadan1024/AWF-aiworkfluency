...
function calcExposure(a: AssessmentAnswer[]): number {
  ...
  // Computer time (0-100 slider → 0-35 points)
  score += (numVal(a, 'q3_computer_pct') / 100) * 35;

  // Repetitiveness (1-5 → 0-25 points)
  score += (numVal(a, 'q4_repetitive') / 5) * 25;

  // Digital-heavy tasks boost exposure (0-25 points)
  ...
  // Work area role weight (0-15 points)
